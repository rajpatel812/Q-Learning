      ...
      <div className="flex flex-col px-2 lg:flex-row lg:items-center">
        <div>
          <div>
            ...
            <div className="mt-6 flex text-base items-center gap-x-3">
              <a href= "/">
          ...
          <div className="mt-10  space-y-6">
            <div>
              <a
                href="#"
                className="hover:underlin text-xl inline-flex items-center gap-x-2 font-semibold text-black"
              >
                <span>About Us</span>
                <ArrowRight size={16} />
              </a>
              <p className="mt-2 text-base text-gray-500">
                Dive in to learn all about our company.
              </p>
            </div>
            <div>
              <a
                href="#"
                className="inline-flex items-center gap-x-2 text-xl font-semibold text-black hover:underline"
              >
                <span>Our blog</span>
                <ArrowRight size={16} />
              </a>
        ...
        <div className="hidden lg:block">
          <img
            ...
            alt="404"
            className="rounded-md object-cover ml-10"
          />
        </div>
      </div>
    </div>
